...
const Footer = () => {
  ...
  const socialLinks = [
    { label: 'Instagram', href: companyInfo?.instagram_url || '#', icon: 'instagram' },
    { label: 'Facebook', href: companyInfo?.facebook_url || '#', icon: 'facebook' },
    { label: 'LinkedIn', href: companyInfo?.linkedin_url || '#', icon: 'linkedin' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} ArchStudio. All rights reserved.
          </p>
